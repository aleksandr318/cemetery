...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Profile Edit</h1>
...
<div class="content">
    <!-- Elements -->
    <form action="{{url('company/EditProfilePost')}}" method="post">
        @csrf
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">Profile Edit</h3>
        </div>
        <div class="block-content">
            ...
            <div class="row push">
                <div class="col-md-12" style="text-align: right;">
                    ...
                    <a href="{{url('company/ViewProfile')}}" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </div>
        </div>
    </div>
