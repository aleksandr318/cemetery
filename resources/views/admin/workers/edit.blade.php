...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Worker Edit</h1>
...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">Edit Worker</h3>
        </div>
        <form action="{{url('/admin/EditWorkerPost')}}" method="post">
            @csrf
            <input name="id" value="{{$worker->id}}" hidden="" />
            <div class="block-content">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="example-text-input">Worker Name</label>
                                    <input type="text" class="form-control" name="name" value="{{$errors->any()?old('name'):$worker->name}}" placeholder="Worker Name">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{$errors->any()?old('email'):$worker->email}}" placeholder="Email">
                                    @if ($errors->has('email'))
                                        <span class="error-note">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="phone" value="{{$errors->any()?old('phone'):$worker->phone}}" onkeypress="return onlyNumberKey(event)" placeholder="Mobile Number">
                                    </div>
                                    @if ($errors->has('phone'))
                                        <span class="error-note">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch custom-control-lg mb-2">
                                        <input type="checkbox" class="custom-control-input" id="account-status" name="status" @if($worker->status=="active")checked=""@endif>
                ...
                <div class="form-group" style="text-align: right; padding-top: 20px;">
                    <a href="{{url('admin/WorkerManagementView')}}" class="btn btn-secondary">Cancel</a>
