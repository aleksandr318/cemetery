...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Burials</h1>
...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">All Burials</h3>
            <div class="block-options">
                <a href="{{url('admin/AddBurialView')}}" class="btn btn-hero-sm btn-hero-primary" data-toggle="tooltip" title="Add new"><i class="fa fa-plus"></i> &nbsp;New burial</a>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php 
                            foreach ($burials as $burial) {
                                ...
                                $bd = DB::table("burial_details")->where("burialId", $burial->id)->first();
                                $status = $bd?"complete":"pending";
                        ?>
                        <tr data-id="{{$burial->id}}">
                            ...
                            <td class="text-center">
                                @if ($bd)
                                <a href="{{url('admin/PlotDetail/'.$bd->plotId)}}" class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-right"></i></a>
                                @endif
                            </td>
                        </tr>
                        <?php 
