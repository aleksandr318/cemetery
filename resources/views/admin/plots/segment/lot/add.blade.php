...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2" id="mtpos" data-lat="" data-long="">Add Lot on section {{$section->name}}</h1>
...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        ...
        <form action="{{url('admin/AddLotPost')}}" id="save-form" method="post">
            @csrf
            <input name="mtId" value="{{$section->mtId}}" hidden="">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Lot ...">
                            </div>
                        </div>
...
<script type="text/javascript">
    function initMap(){
        ...
        drawLots(map, $("#sectionPath").val(), $("#sectionName").val(), sectionId, 0);
