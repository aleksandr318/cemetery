...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2" id="mtpos" data-lat="{{$mount->lat}}" data-long="{{$mount->long}}">Edit Section</h1>
...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        ...
        <form action="{{url('admin/EditSectionPost')}}" id="save-form" method="post">
            @csrf
            <input name="sectionId" value="{{$section->id}}" hidden="">
            <input name="shape_type" id="shape_type" value="Polygon" hidden="">
            <input name="shape_value" id="shape_value" value="{{$section->polygon}}" hidden="">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{$section->name}}" placeholder="Mt...">
                            </div>
                        </div>
...
<input id="mtId" value="{{$section->mtId}}" hidden="" />
@endsection
...
<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAD1SToLwZlpQK8KgGZCl0e9uSBlisdv0U&callback=initMap&libraries=drawing,geometry,places&v=weekly"
      async
    ></script>
...
<script type="text/javascript">
    function initMap() {
        ...
        drawSections(map, mtId, sectionId);
