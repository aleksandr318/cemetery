                            ...
                            <div class="p-3 w-100">
                                ...
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-sm-8 col-xl-6">
                                        <form class="js-validation-signin" action="{{ route('password.request') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="py-3">
                                                ...
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-lg form-control-alt" id="password-confirm" name="password_confirmation" placeholder="Password Confirmation" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <p class="mt-3 mb-0 d-lg-flex justify-content-lg-between">
                                                    <a class="btn btn-sm btn-light d-block d-lg-inline-block mb-1" href="{{ url('login') }}">
                                                        <i class="fa fa-exclamation-triangle text-muted mr-1"></i> Back to login
                                                    </a>
